...
abstract public class BaseTranslator {
    ...
    public String getCurrentTargetLanguage() {
        return getTargetLanguage(HachigramMessagesConfig.INSTANCE.getTranslationTarget());
    }

    public String getCurrentTargetKeyboardLanguage() {
        return getTargetLanguage(HachigramMessagesConfig.INSTANCE.getTranslationKeyboardTarget());
    }
