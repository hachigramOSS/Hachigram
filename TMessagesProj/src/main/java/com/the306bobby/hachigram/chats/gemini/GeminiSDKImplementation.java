...
package com.the306bobby.hachigram.chats.gemini;

import static org.telegram.messenger.LocaleController.getString;
import static com.the306bobby.hachigram.chats.gemini.GeminiResultsBottomSheet.capitalFirst;
import static com.the306bobby.hachigram.chats.gemini.GeminiResultsBottomSheet.languageName;
...
public class GeminiSDKImplementation {
    ...
    public static void initGeminiConfig(
        ...
        configBuilder.temperature = (float) HachigramMessagesConfig.INSTANCE.getGeminiTemperatureValue() / 10;
    ...
    private static void createGenerativeModel(
        ...
        GenerativeModel gm = new GenerativeModel(
                HachigramMessagesConfig.INSTANCE.getGeminiModelName(),
        ...
        Futures.addCallback(response, new FutureCallback<>() {
            ...
            public void onSuccess(GenerateContentResponse result) {
                if (result.getText() != null) {
                    ...
                    if (HachigramCoreConfig.isDevBuild()) FileLog.e("успешный ответ: " + resultText);
    ...
    private static Content buildContent(
        ...
        if (inputBitmap != null || ocr) {
            ...
            if (HachigramCoreConfig.isDevBuild()) FileLog.e("промпт: " + imagePrompt);
        } else if (translateText) { // Message translation
            String lang = capitalFirst(languageName(HachigramMessagesConfig.INSTANCE.getTranslationTargetGemini()));
            ...
            if (HachigramCoreConfig.isDevBuild()) FileLog.e("промпт: " + translationPrompt);
            ...
            if (HachigramCoreConfig.isDevBuild()) FileLog.e("промпт: " + voiceToTextPrompt);
            ...
            if (summarize) {
                ...
                String systemPrompt = HachigramMessagesConfig.INSTANCE.getGeminiSystemPrompt();
                textPrompt = systemPrompt + " " + inputText;
            }

            content.addText(textPrompt);

            if (HachigramCoreConfig.isDevBuild()) FileLog.e("промпт: " + textPrompt);
        }
