...
import com.the306bobby.hachigram.chats.ui.MessageMenuCompactView
...
object CGMessageMenuInjector {
    ...
    fun showGeminiItems(
        ...
        settingsCell.setOnClickListener {
            chatActivity.closeMenu()
            HachigramPreferencesNavigator.createGemini(chatActivity)
        }
    ...
    fun injectClearFromCache(
        ...
        if (HachigramMessagesConfig.showClearFromCache) {
    ...
    fun injectViewHistory(
        ...
        if (HachigramMessagesConfig.showViewHistory) {
    ...
    fun injectSaveMessage(
        ...
        if (HachigramMessagesConfig.showSaveMessage && chatMode != ChatActivity.MODE_SCHEDULED && !UserObject.isUserSelf(
                currentUser
            ) && !message.isSponsored
        ) {
    ...
    fun injectJSON(
        ...
        val show = force || (chatActivity != null && HachigramMessagesConfig.showJSON &&
    ...
    fun removeItems(
        ...
        options.forEachIndexed { index, option ->
            val remove = when (option) {
                ...
                ChatActivity.OPTION_SAVE_TO_GALLERY, ChatActivity.OPTION_SAVE_TO_GALLERY2 -> noforwardsOrPaidMedia || !HachigramMessagesConfig.showSaveToGallery
                ChatActivity.OPTION_SAVE_TO_DOWNLOADS_OR_MUSIC -> noforwardsOrPaidMedia || !HachigramMessagesConfig.showSaveToDownloads
                ChatActivity.OPTION_SHARE -> noforwardsOrPaidMedia || !HachigramMessagesConfig.showShare
                ...
                ChatActivityHelper.OPTION_COPY_PHOTO ->
                    noforwardsOrPaidMedia || !HachigramMessagesConfig.showCopyPhoto || (MessageMenuCompactView.allowCompactStyle() && primaryMessageText == null)
                ChatActivityHelper.OPTION_COPY_PHOTO_AS_STICKER ->
                    noforwardsOrPaidMedia || !HachigramMessagesConfig.showCopyPhotoAsSticker || (MessageMenuCompactView.allowCompactStyle() && primaryMessageText == null)

                ChatActivity.OPTION_FORWARD ->
                    noforwardsOrPaidMedia || !HachigramMessagesConfig.showForward || MessageMenuCompactView.allowCompactStyle()

                ChatActivityHelper.OPTION_FORWARD_WO_AUTHOR ->
                    noforwardsOrPaidMedia || !HachigramMessagesConfig.showForwardWoAuthorship || MessageMenuCompactView.allowCompactStyle()
    ...
    fun showMessageMenuItemsConfigurator(fragment: BaseFragment) {
        val menuItems = listOf(
            MenuItemConfig(
                ...
                { HachigramMessagesConfig.showSaveForNotifications },
                { HachigramMessagesConfig.showSaveForNotifications = !HachigramMessagesConfig.showSaveForNotifications },
                true
            ),
            MenuItemConfig(
                getString(R.string.CP_GeminiAI_Header),
                R.drawable.magic_stick_solar,
                { HachigramMessagesConfig.showGemini },
                { HachigramMessagesConfig.showGemini = !HachigramMessagesConfig.showGemini },
                true
            ),
            MenuItemConfig(
                getString(R.string.Reply),
                R.drawable.menu_reply,
                { HachigramMessagesConfig.showReply },
                { HachigramMessagesConfig.showReply = !HachigramMessagesConfig.showReply }
            ),
            MenuItemConfig(
                getString(R.string.SaveToGallery),
                R.drawable.msg_gallery,
                { HachigramMessagesConfig.showSaveToGallery },
                { HachigramMessagesConfig.showSaveToGallery = !HachigramMessagesConfig.showSaveToGallery }
            ),
            MenuItemConfig(
                getString(R.string.CG_CopyPhoto),
                R.drawable.msg_copy,
                { HachigramMessagesConfig.showCopyPhoto },
                { HachigramMessagesConfig.showCopyPhoto = !HachigramMessagesConfig.showCopyPhoto }
            ),
            MenuItemConfig(
                getString(R.string.CG_CopyPhotoAsSticker),
                R.drawable.msg_copy,
                { HachigramMessagesConfig.showCopyPhotoAsSticker },
                { HachigramMessagesConfig.showCopyPhotoAsSticker = !HachigramMessagesConfig.showCopyPhotoAsSticker }
            ),
            MenuItemConfig(
                getString(R.string.SaveToDownloads),
                R.drawable.msg_download,
                { HachigramMessagesConfig.showSaveToDownloads },
                { HachigramMessagesConfig.showSaveToDownloads = !HachigramMessagesConfig.showSaveToDownloads }
            ),
            MenuItemConfig(
                getString(R.string.ShareFile),
                R.drawable.msg_shareout,
                { HachigramMessagesConfig.showShare },
                { HachigramMessagesConfig.showShare = !HachigramMessagesConfig.showShare }
            ),
            MenuItemConfig(
                getString(R.string.CG_ClearFromCache),
                R.drawable.msg_clear,
                { HachigramMessagesConfig.showClearFromCache },
                { HachigramMessagesConfig.showClearFromCache = !HachigramMessagesConfig.showClearFromCache }
            ),
            MenuItemConfig(
                getString(R.string.Forward),
                R.drawable.msg_forward,
                { HachigramMessagesConfig.showForward },
                { HachigramMessagesConfig.showForward = !HachigramMessagesConfig.showForward }
            ),
            MenuItemConfig(
                getString(R.string.Forward) + " " + getString(R.string.CG_Without_Authorship),
                R.drawable.msg_forward,
                { HachigramMessagesConfig.showForwardWoAuthorship },
                { HachigramMessagesConfig.showForwardWoAuthorship = !HachigramMessagesConfig.showForwardWoAuthorship }
            ),
            MenuItemConfig(
                getString(R.string.AvatarPreviewSearchMessages),
                R.drawable.msg_search,
                { HachigramMessagesConfig.showViewHistory },
                { HachigramMessagesConfig.showViewHistory = !HachigramMessagesConfig.showViewHistory }
            ),
            MenuItemConfig(
                getString(R.string.CG_ToSaved),
                R.drawable.msg_saved,
                { HachigramMessagesConfig.showSaveMessage },
                { HachigramMessagesConfig.showSaveMessage = !HachigramMessagesConfig.showSaveMessage }
            ),
            MenuItemConfig(
                getString(R.string.ReportChat),
                R.drawable.msg_report,
                { HachigramMessagesConfig.showReport },
                { HachigramMessagesConfig.showReport = !HachigramMessagesConfig.showReport }
            ),
            MenuItemConfig(
                "JSON",
                R.drawable.msg_info,
                { HachigramMessagesConfig.showJSON },
                { HachigramMessagesConfig.showJSON = !HachigramMessagesConfig.showJSON }
            )
        )
