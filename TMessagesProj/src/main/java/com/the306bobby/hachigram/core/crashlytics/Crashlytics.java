...
package com.the306bobby.hachigram.core.crashlytics;
...
import com.the306bobby.hachigram.preferences.CameraPreferencesEntry;
...
public class Crashlytics implements Thread.UncaughtExceptionHandler {
    ...
    public static String getReportMessage() {
        return  "Steps to reproduce:\n" +
                ...
                "Details:\n"+
                "• Hachigram Version: " + CGResourcesHelper.getCherryVersion() + " (" + CGResourcesHelper.getAbiCode() + ")\n" +
                ...
                "• Camera: " + CameraPreferencesEntry.getCameraName() + "Dual: " + HachigramCameraConfig.INSTANCE.getUseDualCamera() + "\n" +
