...
package com.the306bobby.hachigram.core.ui.mainTabs
...
object MainTabsManager {
    ...
    private fun loadTabs(): MutableList<Tab> {
        ...
        val value = HachigramAppearanceConfig.mainTabsOrder
    ...
    fun saveTabs(tabs: List<Tab>) {
        ...
        HachigramAppearanceConfig.mainTabsOrder = order.joinToString(",")
    }
