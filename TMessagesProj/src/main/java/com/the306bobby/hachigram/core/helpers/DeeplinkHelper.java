        ...
        if (segments.size() == 1) {
            ...
            switch (segment) {
                case DeepLinksRepo.CG_About-> {
                    HachigramPreferencesNavigator.INSTANCE.createAbout(fragment);
                    return;
                }
                case DeepLinksRepo.CG_Appearance -> {
                    HachigramPreferencesNavigator.INSTANCE.createAppearance(fragment);
                    return;
                }
                case DeepLinksRepo.CG_Camera -> {
                    HachigramPreferencesNavigator.INSTANCE.createCamera(fragment);
                    return;
                }
                case DeepLinksRepo.CG_Chats -> {
                    HachigramPreferencesNavigator.INSTANCE.createChats(fragment);
                    return;
                }
                case DeepLinksRepo.CG_Messages -> {
                    HachigramPreferencesNavigator.INSTANCE.createMessages(fragment);
                    return;
                }
                case DeepLinksRepo.CG_Message_Menu, "cg_messages_menu", "cg_ios_menu" -> {
                    HachigramPreferencesNavigator.INSTANCE.createMessageMenu(fragment);
                    return;
                }
                case DeepLinksRepo.CG_Debug -> {
                    HachigramPreferencesNavigator.INSTANCE.createDebug(fragment);
                    return;
                }
                ...
                case DeepLinksRepo.CG_Experimental -> {
                    HachigramPreferencesNavigator.INSTANCE.createExperimental(fragment);
                    return;
                }
                case DeepLinksRepo.CG_Message_Filters, "cg_filter" -> {
                    HachigramPreferencesNavigator.INSTANCE.createMessageFilter(fragment);
                    return;
                }
                case DeepLinksRepo.CG_Folders -> {
                    HachigramPreferencesNavigator.INSTANCE.createFoldersPrefs(fragment);
                    return;
                }
                ...
                case DeepLinksRepo.CG_Gemini -> {
                    HachigramPreferencesNavigator.INSTANCE.createGemini(fragment);
                    return;
                }
                case DeepLinksRepo.CG_General -> {
                    HachigramPreferencesNavigator.INSTANCE.createGeneral(fragment);
                    return;
                }
                case DeepLinksRepo.CG_Messages_And_Profiles -> {
                    HachigramPreferencesNavigator.INSTANCE.createMessagesAndProfiles(fragment);
                    return;
                }
                ...
                case DeepLinksRepo.CG_Privacy, "cg_security" -> {
                    HachigramPreferencesNavigator.INSTANCE.createPrivacy(fragment);
                    return;
                }
                ...
                case DeepLinksRepo.CG_Settings, "cg_main" -> {
                    HachigramPreferencesNavigator.INSTANCE.createCherrySettings(fragment);
                    return;
                }
                case DeepLinksRepo.CG_Tabs -> {
                    HachigramPreferencesNavigator.INSTANCE.createTabs(fragment);
                    return;
                }
