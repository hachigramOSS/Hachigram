...
package com.the306bobby.hachigram.camera;
...
public class CameraXUtils {
    ...
    public static boolean isCurrentCameraCameraX() {
        return isCameraXSupported() && HachigramCameraConfig.INSTANCE.getCameraType() == HachigramCameraConfig.CAMERA_X;
    }
    ...
    /*public static int getDefaultCamera() { // Used for Config
        return isCameraXSupported() ? HachigramCameraConfig.CAMERA_X : HachigramCameraConfig.TELEGRAM_CAMERA;
    }*/
    ...
    public static void loadSuggestedResolution() {
        ...
        getAvailableVideoSizes().values().stream()
                ...
                .ifPresent(height -> {
                    ...
                    if (HachigramCameraConfig.INSTANCE.getCameraResolution() == -1 || HachigramCameraConfig.INSTANCE.getCameraResolution() > maxResolution || HachigramCameraConfig.INSTANCE.getCameraResolution() < minResolution) {
                        HachigramCameraConfig.INSTANCE.setCameraResolution(
