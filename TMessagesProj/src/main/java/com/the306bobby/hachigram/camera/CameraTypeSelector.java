...
public class CameraTypeSelector extends LinearLayout {
    ...
    int[] icons = new int[]{
            ...
            R.drawable.camera_icon_hachigram,
            R.drawable.camera_icon_camerax,
            R.drawable.camera_icon_system
    };
    int currentIcon = HachigramCameraConfig.INSTANCE.getCameraType();
    ...
    public CameraTypeSelector(Context context) {
        ...
        int selectedButton = HachigramCameraConfig.INSTANCE.getCameraType();
        ...
        if (animate) {
            ...
            animator.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    currentIcon = HachigramCameraConfig.INSTANCE.getCameraType();
