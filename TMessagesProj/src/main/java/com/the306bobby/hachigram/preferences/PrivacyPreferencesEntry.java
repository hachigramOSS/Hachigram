...
public class PrivacyPreferencesEntry extends UniversalFragment {
    ...
    protected void fillItems(ArrayList<UItem> items, UniversalAdapter adapter) {
        ...
        items.add(SettingsHelper.asSwitchCG(proxySponsorRow, getString(R.string.SP_NoProxyPromo))
                .setChecked(HachigramPrivacyConfig.INSTANCE.getHideProxySponsor())
        );
        ...
        if (getChatsPasswordHelper().checkBiometricAvailable()) {
            ...
            if (HachigramPrivacyConfig.INSTANCE.getAskBiometricsToOpenChat()) {
    ...
    protected void onClick(UItem item, View view, int position, float x, float y) {
        if (item.id == proxySponsorRow) {
            HachigramPrivacyConfig.INSTANCE.setHideProxySponsor(!HachigramPrivacyConfig.INSTANCE.getHideProxySponsor());
            SettingsHelper.updateCheckState(view, HachigramPrivacyConfig.INSTANCE.getHideProxySponsor());
            ...
            HachigramPrivacyConfig.INSTANCE.setHideArchivedStories(!HachigramPrivacyConfig.INSTANCE.getHideArchivedStories());
            SettingsHelper.updateCheckState(view, HachigramPrivacyConfig.INSTANCE.getHideArchivedStories());

            CGBulletinCreator.INSTANCE.createRestartBulletin(this);
        } else if (item.id == hideArchiveFromChatsListRow) {
            HachigramPrivacyConfig.INSTANCE.setHideArchiveFromChatsList(!HachigramPrivacyConfig.INSTANCE.getHideArchiveFromChatsList());
            SettingsHelper.updateCheckState(view, HachigramPrivacyConfig.INSTANCE.getHideArchiveFromChatsList());
            ...
            HachigramPrivacyConfig.INSTANCE.setAskPasscodeBeforeDelete(!HachigramPrivacyConfig.INSTANCE.getAskPasscodeBeforeDelete());
            SettingsHelper.updateCheckState(view, HachigramPrivacyConfig.INSTANCE.getAskPasscodeBeforeDelete());
        } else if (item.id == allowSystemPinRow) {
            HachigramPrivacyConfig.INSTANCE.setAllowSystemPasscode(!HachigramPrivacyConfig.INSTANCE.getAllowSystemPasscode());
            SettingsHelper.updateCheckState(view, HachigramPrivacyConfig.INSTANCE.getAllowSystemPasscode());
    ...
    private void showPasscodeItemsSelector() {
        List<MenuItemConfig> menuItems = Arrays.asList(
                new MenuItemConfig(
                        ...
                        0,
                        HachigramPrivacyConfig.INSTANCE::getAskBiometricsToOpenChat,
                        () -> {
                            HachigramPrivacyConfig.INSTANCE.setAskBiometricsToOpenChat(!HachigramPrivacyConfig.INSTANCE.getAskBiometricsToOpenChat());
                            if (listView != null && listView.adapter != null) listView.adapter.update(true);
                        }
                ),
                new MenuItemConfig(
                        ...
                        0,
                        HachigramPrivacyConfig.INSTANCE::getAskBiometricsToOpenEncrypted,
                        () -> HachigramPrivacyConfig.INSTANCE.setAskBiometricsToOpenEncrypted(!HachigramPrivacyConfig.INSTANCE.getAskBiometricsToOpenEncrypted())
                ),
                new MenuItemConfig(
                        getString(R.string.ArchivedChats),
                        0,
                        HachigramPrivacyConfig.INSTANCE::getAskBiometricsToOpenArchive,
                        () -> HachigramPrivacyConfig.INSTANCE.setAskBiometricsToOpenArchive(!HachigramPrivacyConfig.INSTANCE.getAskBiometricsToOpenArchive()),
                        false
                )
        );
