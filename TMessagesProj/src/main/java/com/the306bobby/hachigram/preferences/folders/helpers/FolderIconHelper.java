...
package com.the306bobby.hachigram.preferences.folders.helpers;
...
//        folderIcons.put("\uD83D\uDCA1", R.drawable.filter_light_solar2);
    ...
    public static int getPadding() {
        if (HachigramAppearanceConfig.INSTANCE.getTabMode() == HachigramAppearanceConfig.TAB_TYPE_MIX) {
    ...
    public static int getTotalIconWidth() {
        int result = 0;
        if (HachigramAppearanceConfig.INSTANCE.getTabMode() != HachigramAppearanceConfig.TAB_TYPE_TEXT) {
    ...
    public static int getInternalPaddingTab() {
        /*if (HachigramAppearanceConfig.INSTANCE.getTabMode() != HachigramAppearanceConfig.TAB_TYPE_ICON) {
