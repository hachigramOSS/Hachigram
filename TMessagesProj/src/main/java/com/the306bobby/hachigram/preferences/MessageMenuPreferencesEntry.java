    ...
    public View createView(Context context) {
        ...
        listView.setOnItemClickListener((view, position, x, y) -> {
            ...
            if (position == enableNewMessageMenuRow) {
                HachigramMessagesConfig.INSTANCE.setBlurMessageMenuBackground(!HachigramMessagesConfig.INSTANCE.getBlurMessageMenuBackground());
                if (view instanceof TextCheckCell) {
                    ((TextCheckCell) view).setChecked(HachigramMessagesConfig.INSTANCE.getBlurMessageMenuBackground());
                }
                ...
                HachigramMessagesConfig.INSTANCE.setMsgMenuUnifiedScroll(!HachigramMessagesConfig.INSTANCE.getMsgMenuUnifiedScroll());
                if (view instanceof TextCheckCell) {
                    ((TextCheckCell) view).setChecked(HachigramMessagesConfig.INSTANCE.getMsgMenuUnifiedScroll());

                    /*if (HachigramMessagesConfig.INSTANCE.getMsgMenuUnifiedScroll() && !HachigramMessagesConfig.INSTANCE.getBlurMessageMenuBackground()) {
                        HachigramMessagesConfig.INSTANCE.setBlurMessageMenuBackground(true);
                        listAdapter.notifyItemChanged(enableNewMessageMenuRow, false);
                    }

                    HachigramMessagesConfig.INSTANCE.setMsgMenuFixedHeight(!HachigramMessagesConfig.INSTANCE.getMsgMenuUnifiedScroll() || !HachigramMessagesConfig.INSTANCE.getMsgMenuFixedHeight());*/

                    listAdapter.notifyItemChanged(autoScrollMessagesRow, false);
                    listAdapter.notifyItemChanged(fixedMessageHeightRow, false);
                }
            } else if (position == autoScrollMessagesRow) {
                HachigramMessagesConfig.INSTANCE.setMsgMenuAutoScroll(!HachigramMessagesConfig.INSTANCE.getMsgMenuAutoScroll());
                if (view instanceof TextCheckCell) {
                    ((TextCheckCell) view).setChecked(HachigramMessagesConfig.INSTANCE.getMsgMenuAutoScroll());

                    if (HachigramMessagesConfig.INSTANCE.getMsgMenuAutoScroll() && !HachigramMessagesConfig.INSTANCE.getBlurMessageMenuBackground()) {
                        HachigramMessagesConfig.INSTANCE.setBlurMessageMenuBackground(true);
                        listAdapter.notifyItemChanged(enableNewMessageMenuRow, false);
                    }
                }
            } else if (position == fixedMessageHeightRow) {
                HachigramMessagesConfig.INSTANCE.setMsgMenuFixedHeight(!HachigramMessagesConfig.INSTANCE.getMsgMenuFixedHeight());
                if (view instanceof TextCheckCell) {
                    ((TextCheckCell) view).setChecked(HachigramMessagesConfig.INSTANCE.getMsgMenuFixedHeight());

                    if (HachigramMessagesConfig.INSTANCE.getMsgMenuFixedHeight() && !HachigramMessagesConfig.INSTANCE.getBlurMessageMenuBackground()) {
                        HachigramMessagesConfig.INSTANCE.setBlurMessageMenuBackground(true);
                        listAdapter.notifyItemChanged(enableNewMessageMenuRow, false);
                    }
                }
            } else if (position == blurMessageMenuItemsRow) {
                HachigramMessagesConfig.INSTANCE.setBlurMessageMenuItems(!HachigramMessagesConfig.INSTANCE.getBlurMessageMenuItems());
                if (view instanceof TextCheckCell) {
                    ((TextCheckCell) view).setChecked(HachigramMessagesConfig.INSTANCE.getBlurMessageMenuItems());

                    if (HachigramMessagesConfig.INSTANCE.getBlurMessageMenuItems() && !HachigramMessagesConfig.INSTANCE.getBlurMessageMenuBackground()) {
                        HachigramMessagesConfig.INSTANCE.setBlurMessageMenuBackground(true);
                        listAdapter.notifyItemChanged(enableNewMessageMenuRow, false);
                    }
                }
            } else if (position == useNativeBlurRow) {
                HachigramMessagesConfig.INSTANCE.setMsgMenuNativeBlur(!HachigramMessagesConfig.INSTANCE.getMsgMenuNativeBlur());
                if (view instanceof TextCheckCell) {
                    ((TextCheckCell) view).setChecked(HachigramMessagesConfig.INSTANCE.getMsgMenuNativeBlur());

                    if (HachigramMessagesConfig.INSTANCE.getMsgMenuNativeBlur() && !HachigramMessagesConfig.INSTANCE.getBlurMessageMenuBackground()) {
                        HachigramMessagesConfig.INSTANCE.setBlurMessageMenuBackground(true);
                        listAdapter.notifyItemChanged(enableNewMessageMenuRow, false);
                    }
                }
                ...
                HachigramMessagesConfig.INSTANCE.setMsgMenuItemsCompactView(!HachigramMessagesConfig.INSTANCE.getMsgMenuItemsCompactView());
                if (view instanceof TextCheckCell) {
                    ((TextCheckCell) view).setChecked(HachigramMessagesConfig.INSTANCE.getMsgMenuItemsCompactView());
                }
            }
        });
                ...
                case VIEW_TYPE_TEXT_CHECK:
                    ...
                    if (position == enableNewMessageMenuRow) {
                        ...
                        textCheckCell.setTextAndValueAndCheck(
                                ...
                                HachigramMessagesConfig.INSTANCE.getBlurMessageMenuBackground(),
                                true,
                                true
                        );
                    } else if (position == unifiedScrollRow) {
                        textCheckCell.setEnabled(HachigramMessagesConfig.INSTANCE.getBlurMessageMenuBackground(), null);
                        textCheckCell.setTextAndValueAndCheck(
                                getString(R.string.CP_MessageMenuUnifiedScroll),
                                getString(R.string.CP_MessageMenuUnifiedScroll_Desc),
                                HachigramMessagesConfig.INSTANCE.getMsgMenuUnifiedScroll(),
                                true,
                                true
                        );
                    } else if (position == autoScrollMessagesRow) {
                        textCheckCell.setEnabled(HachigramMessagesConfig.INSTANCE.getBlurMessageMenuBackground() && !HachigramMessagesConfig.INSTANCE.getMsgMenuUnifiedScroll(), null);
                        textCheckCell.setTextAndValueAndCheck(
                                getString(R.string.CP_MessageMenuAutoscroll),
                                getString(R.string.CP_MessageMenuAutoscroll_Desc),
                                HachigramMessagesConfig.INSTANCE.getMsgMenuAutoScroll(),
                                true,
                                true
                        );
                    } else if (position == fixedMessageHeightRow) {
                        ...
                        textCheckCell.setTextAndValueAndCheck(
                                ...
                                HachigramMessagesConfig.INSTANCE.getMsgMenuFixedHeight(),
                                true,
                                true
                        );
                    } else if (position == blurMessageMenuItemsRow) {
                        ...
                        textCheckCell.setTextAndValueAndCheck(
                                ...
                                HachigramMessagesConfig.INSTANCE.getBlurMessageMenuItems(),
                                true,
                                true
                        );
                    } else if (position == useNativeBlurRow) {
                        ...
                        textCheckCell.setTextAndValueAndCheck(
                                ...
                                HachigramMessagesConfig.INSTANCE.getMsgMenuNativeBlur(),
                                true,
                                false
                        );
                    } else if (position == messageMenuItemsCompactView) {
                        ...
                        textCheckCell.setTextAndValueAndCheck(
                                ...
                                HachigramMessagesConfig.INSTANCE.getMsgMenuItemsCompactView(),
                                true,
                                false
                        );
                    }
