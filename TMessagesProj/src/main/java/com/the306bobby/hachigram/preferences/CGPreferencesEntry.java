...
//        items.add(UItem.asButton(experimentalRow, R.drawable.msg_fave_solar, getString(R.string.EP_Category_Experimental)));
    ...
    protected void onClick(UItem item, View view, int position, float x, float y) {
        if (item.id == generalRow) {
            HachigramPreferencesNavigator.INSTANCE.createGeneral(this);
        } else if (item.id == appearanceRow) {
            HachigramPreferencesNavigator.INSTANCE.createAppearance(this);
        } else if (item.id == chatsRow) {
            HachigramPreferencesNavigator.INSTANCE.createChats(this);
        } else if (item.id == cameraRow) {
            HachigramPreferencesNavigator.INSTANCE.createCamera(this);
        } else if (item.id == experimentalRow) {
            HachigramPreferencesNavigator.INSTANCE.createExperimental(this);
        } else if (item.id == privacyRow) {
            HachigramPreferencesNavigator.INSTANCE.createPrivacy(this);
            ...
            HachigramPreferencesNavigator.INSTANCE.createAbout(this);
        }
    }
