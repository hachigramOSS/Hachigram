...
public class ChatsPreferencesEntry extends UniversalFragment {
    ...
    protected void fillItems(ArrayList<UItem> items, UniversalAdapter adapter) {
        ...
        items.add(SettingsHelper.asSwitchCG(centerTitleRow, getString(R.string.AP_CenterTitle))
                .setChecked(HachigramChatsConfig.INSTANCE.getCenterChatTitle())
        );
        items.add(SettingsHelper.asSwitchCG(unreadBadgeRow, getString(R.string.CP_UnreadBadgeOnBackButton), getString(R.string.CP_UnreadBadgeOnBackButton_Desc))
                .setChecked(HachigramChatsConfig.INSTANCE.getUnreadBadgeOnBackButton())
        );
        ...
        items.add(SettingsHelper.asSwitchCG(sendAsChannelButtonRow, getString(R.string.CP_HideSendAsChannel), getString(R.string.CP_HideSendAsChannelDesc))
                .setChecked(HachigramChatsConfig.INSTANCE.getHideSendAsChannel())
        );
        ...
        items.add(SettingsHelper.asSwitchCG(customChatRow, getString(R.string.EP_CustomChat), getString(R.string.EP_CustomChat_Desc))
                .setChecked(HachigramChatsConfig.INSTANCE.getCustomChatForSavedMessages())
        );
        if (HachigramChatsConfig.INSTANCE.getCustomChatForSavedMessages()) {
        ...
        items.add(SettingsHelper.asSwitchCG(autoQuoteRow, getString(R.string.CP_AutoQuoteReplies), getString(R.string.CP_AutoQuoteReplies_Desc))
                .setChecked(HachigramChatsConfig.INSTANCE.getAutoQuoteReplies())
        );
        items.add(SettingsHelper.asSwitchCG(disableSwipeToNextRow, getString(R.string.CP_DisableSwipeToNext), getString(R.string.CP_DisableSwipeToNext_Desc))
                .setChecked(HachigramChatsConfig.INSTANCE.getDisableSwipeToNext())
        );
        items.add(SettingsHelper.asSwitchCG(disableVibrationRow, getString(R.string.CP_DisableVibration))
                .setChecked(HachigramChatsConfig.INSTANCE.getDisableVibration())
        );
        items.add(UItem.asShadow(null));
        ...
        items.add(
                UItem.asIntSlideView(
                        1,
                        0,
                        HachigramChatsConfig.INSTANCE.getHideKeyboardOnScrollIntensity(),
                        10,
                        val -> val == 0 ? getString(R.string.VibrationDisabled) : String.valueOf(val),
                        HachigramChatsConfig.INSTANCE::setHideKeyboardOnScrollIntensity
                )
        );
        items.add(UItem.asShadow(null));
        ...
        items.add(SettingsHelper.asSwitchCG(largePhotosRow, getString(R.string.EP_PhotosSize))
                .setChecked(HachigramChatsConfig.INSTANCE.getLargePhotos())
        );
        items.add(SettingsHelper.asSwitchCG(playVideoOnVolumeBtnRow, getString(R.string.CP_PlayVideo), getString(R.string.CP_PlayVideo_Desc))
                .setChecked(HachigramChatsConfig.INSTANCE.getPlayVideoOnVolume())
        );
        items.add(SettingsHelper.asSwitchCG(autoPauseVideoRow, getString(R.string.CP_AutoPauseVideo), getString(R.string.CP_AutoPauseVideo_Desc))
                .setChecked(HachigramChatsConfig.INSTANCE.getAutoPauseVideo())
        );
        items.add(UItem.asShadow(null));
        ...
        items.add(
                UItem.asIntSlideView(
                        1,
                        0,
                        HachigramChatsConfig.INSTANCE.getVideoSeekDuration(),
                        25,
                        val -> val == 0 ? getString(R.string.VibrationDisabled) : String.valueOf(val),
                        HachigramChatsConfig.INSTANCE::setVideoSeekDuration
                )
        );
        items.add(UItem.asShadow(null));
    ...
    protected void onClick(UItem item, View view, int position, float x, float y) {
        if (item.id == centerTitleRow) {
            HachigramChatsConfig.INSTANCE.setCenterChatTitle(!HachigramChatsConfig.INSTANCE.getCenterChatTitle());
            SettingsHelper.updateCheckState(view, HachigramChatsConfig.INSTANCE.getCenterChatTitle());

            getParentLayout().rebuildAllFragmentViews(false, false);
        } else if (item.id == unreadBadgeRow) {
            HachigramChatsConfig.INSTANCE.setUnreadBadgeOnBackButton(!HachigramChatsConfig.INSTANCE.getUnreadBadgeOnBackButton());
            SettingsHelper.updateCheckState(view, HachigramChatsConfig.INSTANCE.getUnreadBadgeOnBackButton());
        } else if (item.id == chatMenuShortcutsRow) {
            showChatMenuItemsConfigurator(this);
        } else if (item.id == customBackgroundInChatsRow) {
            HachigramChatsConfig.INSTANCE.setCustomWallpapers(!HachigramChatsConfig.INSTANCE.getCustomWallpapers());
            SettingsHelper.updateCheckState(view, HachigramChatsConfig.INSTANCE.getCustomWallpapers());
        } else if (item.id == snowflakesRow) {
            HachigramChatsConfig.INSTANCE.setDrawSnowInChat(!HachigramChatsConfig.INSTANCE.getDrawSnowInChat());
            SettingsHelper.updateCheckState(view, HachigramChatsConfig.INSTANCE.getDrawSnowInChat());

            getParentLayout().rebuildAllFragmentViews(false, false);
        } else if (item.id == hideBottomBarRow) {
            HachigramChatsConfig.INSTANCE.setHideMuteUnmuteButton(!HachigramChatsConfig.INSTANCE.getHideMuteUnmuteButton());
            SettingsHelper.updateCheckState(view, HachigramChatsConfig.INSTANCE.getHideMuteUnmuteButton());
        } else if (item.id == sendAsChannelButtonRow) {
            HachigramChatsConfig.INSTANCE.setHideSendAsChannel(!HachigramChatsConfig.INSTANCE.getHideSendAsChannel());
            SettingsHelper.updateCheckState(view, HachigramChatsConfig.INSTANCE.getHideSendAsChannel());
            ...
            HachigramPreferencesNavigator.INSTANCE.createMessages(this);
        } else if (item.id == customChatRow) {
            HachigramChatsConfig.INSTANCE.setCustomChatForSavedMessages(!HachigramChatsConfig.INSTANCE.getCustomChatForSavedMessages());
            SettingsHelper.updateCheckState(view, HachigramChatsConfig.INSTANCE.getCustomChatForSavedMessages());

            listView.adapter.update(true);
        } else if (item.id == autoQuoteRow) {
            HachigramChatsConfig.INSTANCE.setAutoQuoteReplies(!HachigramChatsConfig.INSTANCE.getAutoQuoteReplies());
            SettingsHelper.updateCheckState(view, HachigramChatsConfig.INSTANCE.getAutoQuoteReplies());
        } else if (item.id == disableSwipeToNextRow) {
            HachigramChatsConfig.INSTANCE.setDisableSwipeToNext(!HachigramChatsConfig.INSTANCE.getDisableSwipeToNext());
            SettingsHelper.updateCheckState(view, HachigramChatsConfig.INSTANCE.getDisableSwipeToNext());
        } else if (item.id == disableVibrationRow) {
            HachigramChatsConfig.INSTANCE.setDisableVibration(!HachigramChatsConfig.INSTANCE.getDisableVibration());
            SettingsHelper.updateCheckState(view, HachigramChatsConfig.INSTANCE.getDisableVibration());

            CGBulletinCreator.INSTANCE.createRestartBulletin(this);
        } else if (item.id == largePhotosRow) {
            HachigramChatsConfig.INSTANCE.setLargePhotos(!HachigramChatsConfig.INSTANCE.getLargePhotos());
            SettingsHelper.updateCheckState(view, HachigramChatsConfig.INSTANCE.getLargePhotos());

            CGBulletinCreator.INSTANCE.createRestartBulletin(this);
        } else if (item.id == playVideoOnVolumeBtnRow) {
            HachigramChatsConfig.INSTANCE.setPlayVideoOnVolume(!HachigramChatsConfig.INSTANCE.getPlayVideoOnVolume());
            SettingsHelper.updateCheckState(view, HachigramChatsConfig.INSTANCE.getPlayVideoOnVolume());
        } else if (item.id == autoPauseVideoRow) {
            HachigramChatsConfig.INSTANCE.setAutoPauseVideo(!HachigramChatsConfig.INSTANCE.getAutoPauseVideo());
            SettingsHelper.updateCheckState(view, HachigramChatsConfig.INSTANCE.getAutoPauseVideo());
            ...
            showNotificationSoundSelector(() -> {
                ...
                int tone = (HachigramChatsConfig.INSTANCE.getNotificationSound() == HachigramChatsConfig.NOTIF_SOUND_DEFAULT) ? R.raw.sound_in : R.raw.sound_in_ios;
                try {
            ...
            showVibrationSelector(() -> {
                try {
                    switch (HachigramChatsConfig.INSTANCE.getVibrateInChats()) {
                        case HachigramChatsConfig.VIBRATION_CLICK ->
                                VibrateUtil.INSTANCE.makeClickVibration();
                        case HachigramChatsConfig.VIBRATION_WAVE_FORM ->
                                VibrateUtil.INSTANCE.makeWaveVibration();
                        case HachigramChatsConfig.VIBRATION_KEYBOARD_TAP ->
                                VibrateUtil.INSTANCE.vibrate(HapticFeedbackConstants.KEYBOARD_TAP);
                        case HachigramChatsConfig.VIBRATION_LONG ->
    ...
    public static void showChatMenuItemsConfigurator(BaseFragment fragment) {
        List<MenuItemConfig> menuItems = Arrays.asList(
                new MenuItemConfig(
                        ...
                        HachigramChatsConfig.INSTANCE::getShortcut_JumpToBegin,
                        () -> HachigramChatsConfig.INSTANCE.setShortcut_JumpToBegin(!HachigramChatsConfig.INSTANCE.getShortcut_JumpToBegin()),
                        false,
                        false
                ),
                new MenuItemConfig(
                        ...
                        HachigramChatsConfig.INSTANCE::getShortcut_DeleteAll,
                        () -> HachigramChatsConfig.INSTANCE.setShortcut_DeleteAll(!HachigramChatsConfig.INSTANCE.getShortcut_DeleteAll()),
                        false,
                        false
                ),
                new MenuItemConfig(
                        ...
                        HachigramChatsConfig.INSTANCE::getShortcut_SavedMessages,
                        () -> HachigramChatsConfig.INSTANCE.setShortcut_SavedMessages(!HachigramChatsConfig.INSTANCE.getShortcut_SavedMessages()),
                        false,
                        false
                ),
                new MenuItemConfig(
                        ...
                        HachigramChatsConfig.INSTANCE::getShortcut_Browser,
                        () -> HachigramChatsConfig.INSTANCE.setShortcut_Browser(!HachigramChatsConfig.INSTANCE.getShortcut_Browser()),
                        true,
                        false
                ),
                new MenuItemConfig(
    ...
    private static void showChatAdminItemsConfigurator(BaseFragment fragment) {
        List<MenuItemConfig> menuItems = Arrays.asList(
                new MenuItemConfig(
                        ...
                        HachigramChatsConfig.INSTANCE::getAdmins_Reactions,
                        () -> HachigramChatsConfig.INSTANCE.setAdmins_Reactions(!HachigramChatsConfig.INSTANCE.getAdmins_Reactions()),
                        false,
                        false
                ),
                new MenuItemConfig(
                        ...
                        HachigramChatsConfig.INSTANCE::getAdmins_Permissions,
                        () -> HachigramChatsConfig.INSTANCE.setAdmins_Permissions(!HachigramChatsConfig.INSTANCE.getAdmins_Permissions()),
                        false,
                        false
                ),
                new MenuItemConfig(
                        ...
                        R.drawable.msg_admins,
                        HachigramChatsConfig.INSTANCE::getAdmins_Administrators,
                        () -> HachigramChatsConfig.INSTANCE.setAdmins_Administrators(!HachigramChatsConfig.INSTANCE.getAdmins_Administrators()),
                        false,
                        false
                ),
                new MenuItemConfig(
                        ...
                        HachigramChatsConfig.INSTANCE::getAdmins_Members,
                        () -> HachigramChatsConfig.INSTANCE.setAdmins_Members(!HachigramChatsConfig.INSTANCE.getAdmins_Members()),
                        false,
                        false
                ),
                new MenuItemConfig(
                        ...
                        HachigramChatsConfig.INSTANCE::getAdmins_Statistics,
                        () -> HachigramChatsConfig.INSTANCE.setAdmins_Statistics(!HachigramChatsConfig.INSTANCE.getAdmins_Statistics()),
                        false,
                        false
                ),
                new MenuItemConfig(
                        ...
                        R.drawable.msg_log,
                        HachigramChatsConfig.INSTANCE::getAdmins_RecentActions,
                        () -> HachigramChatsConfig.INSTANCE.setAdmins_RecentActions(!HachigramChatsConfig.INSTANCE.getAdmins_RecentActions()),
                        false,
                        false
                )
        );
    ...
    private String getNotificationSoundValue() {
        return switch (HachigramChatsConfig.INSTANCE.getNotificationSound()) {
            case HachigramChatsConfig.NOTIF_SOUND_DEFAULT -> getString(R.string.Default);
            case HachigramChatsConfig.NOTIF_SOUND_IOS -> "iOS";
    ...
    private void showNotificationSoundSelector(Runnable runnable) {
        ...
        configValues.add(HachigramChatsConfig.NOTIF_SOUND_DISABLE);

        configStringKeys.add(getString(R.string.Default));
        configValues.add(HachigramChatsConfig.NOTIF_SOUND_DEFAULT);

        configStringKeys.add("iOS");
        configValues.add(HachigramChatsConfig.NOTIF_SOUND_IOS);

        PopupHelper.show(configStringKeys, getString(R.string.NotificationsSound), configValues.indexOf(HachigramChatsConfig.INSTANCE.getNotificationSound()), getContext(), i -> {
            HachigramChatsConfig.INSTANCE.setNotificationSound(configValues.get(i));
            if (runnable != null) runnable.run();
        });
    }

    private String getVibrationValue() {
        return switch (HachigramChatsConfig.INSTANCE.getVibrateInChats()) {
            case HachigramChatsConfig.VIBRATION_CLICK -> "1";
            case HachigramChatsConfig.VIBRATION_WAVE_FORM -> "2";
            case HachigramChatsConfig.VIBRATION_KEYBOARD_TAP -> "3";
            case HachigramChatsConfig.VIBRATION_LONG -> "4";
    ...
    private void showVibrationSelector(Runnable runnable) {
        ...
        configValues.add(HachigramChatsConfig.VIBRATION_DISABLE);

        configStringKeys.add("1");
        configValues.add(HachigramChatsConfig.VIBRATION_CLICK);

        configStringKeys.add("2");
        configValues.add(HachigramChatsConfig.VIBRATION_WAVE_FORM);

        configStringKeys.add("3");
        configValues.add(HachigramChatsConfig.VIBRATION_KEYBOARD_TAP);

        configStringKeys.add("4");
        configValues.add(HachigramChatsConfig.VIBRATION_LONG);

        PopupHelper.show(configStringKeys, getString(R.string.CP_VibrateInChats), configValues.indexOf(HachigramChatsConfig.INSTANCE.getVibrateInChats()), getContext(), i -> {
            HachigramChatsConfig.INSTANCE.setVibrateInChats(configValues.get(i));
            if (runnable != null) runnable.run();
        });
    }
