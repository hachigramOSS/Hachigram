...
public class FileUploadOperation {
    ...
    public void start() {
        ...
        Utilities.stageQueue.postRunnable(() -> {
            ...
            slowNetwork = HachigramCoreConfig.INSTANCE.getSlowNetworkMode();
...
//                }
                ...
                uploadChunkSize = (int) Math.max(slowNetwork ? minUploadChunkSlowNetworkSize : HachigramCoreConfig.INSTANCE.getUploadSpeedBoost() ? minUploadChunkSizeBoost : minUploadChunkSize, (totalFileSize + 1024L * maxUploadParts - 1) / (1024L * maxUploadParts));
